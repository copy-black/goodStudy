package com.goodstudy.content.jobhandler;


import com.goodstudy.base.exception.GoodStudyException;
import com.goodstudy.content.feignclient.CourseIndex;
import com.goodstudy.content.feignclient.SearchServiceClient;
...
import com.goodstudy.messagesdk.service.MessageProcessAbstract;
...
public class CoursePublishTask extends MessageProcessAbstract {
    ...
    private void generateCourseHtml(MqMessage mqMessage,long courseId){
        ...
        if(file == null){
            GoodStudyException.cast("生成的静态页面为空");
        }
        // 将html上传到minio
    ...
    private void saveCourseIndex(MqMessage mqMessage,long courseId){
        ...
        if(!add){
            GoodStudyException.cast("远程调用搜索服务添加课程索引失败");
        }
        //完成本阶段的任务
