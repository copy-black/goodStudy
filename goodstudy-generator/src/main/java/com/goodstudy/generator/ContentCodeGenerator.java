package com.goodstudy.generator;
...
//			"mq_message_history"
	...
	public static void main(String[] args) {
		...
		//生成路径
		gc.setOutputDir(System.getProperty("user.dir") + "/goodstudy-generator/src/main/java");
		gc.setAuthor("jack");
		gc.setOpen(false);
		...
		dsc.setUrl("jdbc:mysql://localhost:3306/gs_" + SERVICE_NAME
